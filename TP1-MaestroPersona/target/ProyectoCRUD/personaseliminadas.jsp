						...
						<form class="row g-3 needs-validation" novalidate>
							...
							<div class="col-md-4">
								...
								<input type="text" class="form-control" id="frmLast_names"
									   required>
								<div class="valid-feedback">Se ve bien!</div>
								<div class="invalid-feedback">Por favor, coloque algo v
									lido.</div>
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								...
								<div class="invalid-feedback">Por favor, coloque un n
									mero de documento v lido.</div>
							</div>
							<div class="col-md-4">
								<label for="frmAddress" class="form-label">Dirección</label> <input
							...
							<div class="col-md-4">
								<label for="frmPassword" class="form-label">Contraseña</label>
